      ...
      body: Container(
        ...
        child: Column(children: <Widget>[
          ...
          TextField(
              ...
              decoration: InputDecoration(labelText: 'Number of reaches',hintText: _reach.nSections.toString()),
              keyboardType: TextInputType.number,
            ),
          TextField(
            controller: notesController,
              decoration: InputDecoration(labelText: 'Notes',hintText: _reach.notes),
              maxLines: 5,
          ...
          Container(
              ...
              child: FlatButton(
                onPressed: () {
                  _submit(nameController.text,
                      sectionsController.text==''?0:int.parse(sectionsController.text), notesController.text);
                }, 
                child: Text(
                  'Submit',
