...
import 'package:gamma/screens/edit_river.dart';
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Text(
                    _r.name,
                    style: TextStyle(
                        color: Theme.of(context).primaryColor, fontSize:_r.name.length>=5? ((MediaQuery.of(context).size.width*0.05*5)/_r.name.length):MediaQuery.of(context).size.width*0.05),
                  ),
                ),
                Container(
